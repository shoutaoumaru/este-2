          ...
          <li class="c-points__item">
            ...
            <div class="c-points__desc">
              <h4>
                <div class="num-wrap">
                  <p class="num">01</p>
                  <p class="item-tit">安心、安全で
                    「結果」の出るエステティックサロン</p>
                </div>
                <div class="item-desc">
                  <p class="c-txt-sm">
                  お客様ひとりひとりの、お顔立ち、肌質、ご希望に合わせたオーダーメイドのケアの高い技術で丁寧にサポートします。</p>
                </div>
              </h4>
            </div>
          </li>
          <li class="c-points__item">
            ...
            <div class="c-points__desc">
              <h4>
                <div class="num-wrap">
                  <p class="num">02</p>
                  <p class="item-tit">最新機種【ハイパーナイフEX】大人気ハイパーシリーズの最新機種。燃焼力はシリーズ最高クラス</p>
                </div>
          ...
          <li class="c-points__item">
            ...
            <div class="c-points__desc">
              <h4>
                ...
                <div class="item-desc">
                  <p class="c-txt-sm">お肌に不必要な成分は一切入れない「完全無添加化粧品」使用で安心。<br>お肌に良いものだけを追求し、今までにない肌の変化をご提案いたします。
                  </p>
                </div>
              </h4>
            </div>
          ...
          <li class="c-points__item">
            ...
            <div class="c-points__desc">
              <h4>
                ...
                <div class="item-desc">
                  <p class="c-txt-sm">
                    角質だけの簡単なケアではありません。お肌トラブルの原因は見えている「表面」ではなく、「内側」の状態が重要です。「内側」の状態が整う事でお肌のサイクルを正常化し、潤いのあるお肌へと導きます。</p>
                </div>
              </h4>
            </div>
          </li>
          <li class="c-points__item">
            ...
            <div class="c-points__desc">
              <h4>
                <div class="num-wrap">
                  <p class="num">05</p>
                  <p class="item-tit">「究極の癒やし」と言われる、オイルヘッドマッサージ</p>
                </div>
                <div class="item-desc">
                  <p class="c-txt-sm">
              ...
              <h4>
                ...
                <div class="item-desc">
                  ...
                  <p class="c-txt-sm">
                    ...
                    ご希望以外のメニューや商品の購入を無理に勧めることはいたしません。</p>
                </div>
              </h4>
            </div>
          </li>
